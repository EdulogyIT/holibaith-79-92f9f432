...
const allTranslations = {
  FR: {
    ...
    about: 'À propos',
    aboutHolibayt: 'À propos de Holibayt',
    aboutHeroSubtitle: 'Redéfinir l\'hospitalité en Algérie à travers des expériences de luxe sélectionnées et des connexions authentiques',
    ourMissionTitle: 'Notre Mission',
    ourMissionText: 'Holibayt a pour mission de montrer la beauté et l\'hospitalité de l\'Algérie au monde entier. Nous sélectionnons soigneusement des hôtels de luxe et des séjours courts authentiques qui représentent le meilleur de la culture, de l\'architecture et de la chaleur algériennes. Chaque propriété sur notre plateforme est personnellement inspectée pour garantir qu\'elle répond à nos normes exigeantes de qualité, d\'authenticité et d\'excellence.',
    ourValuesTitle: 'Nos Valeurs',
    valueTrust: 'Confiance',
    valueTrustDesc: 'Chaque propriété est vérifiée et inspectée pour garantir les normes de sécurité et de qualité',
    valueExcellence: 'Excellence',
    valueExcellenceDesc: 'Nous ne collaborons qu\'avec des propriétés qui démontrent une hospitalité exceptionnelle',
    valueAuthenticity: 'Authenticité',
    valueAuthenticityDesc: 'Des expériences authentiques qui mettent en valeur le véritable esprit de la culture algérienne',
    valueCommunity: 'Communauté',
    valueCommunityDesc: 'Soutenir les entreprises locales et favoriser les connexions entre hôtes et invités',
    ourTeamTitle: 'Notre Équipe',
    ourTeamSubtitle: 'Un groupe dévoué d\'experts en hospitalité, de guides locaux et d\'innovateurs technologiques',
    teamMember1Name: 'Amina Benali',
    teamMember1Role: 'PDG & Fondatrice',
    teamMember2Name: 'Karim Mansouri',
    teamMember2Role: 'Directeur des Opérations',
    teamMember3Name: 'Leila Cherif',
    teamMember3Role: 'Directrice de l\'Hospitalité',
    blog: 'Blog',
    login: 'Se connecter',
    ...
    // Hotels Page
    findYourIdealHotel: 'Trouvez votre hôtel idéal en Algérie',
    fromLuxuryResorts: 'Des complexes de luxe aux hôtels d\'affaires - comparez les prix et réservez directement',
    trendingDestinations: 'Destinations tendance',
    mostPopularChoices: 'Choix les plus populaires pour les voyageurs en Algérie',
    browseByAccommodation: 'Parcourir par type d\'hébergement',
    discoverStaysStyle: 'Découvrez des séjours adaptés à votre style',
    highlyRatedHotels: 'Hôtels très bien notés',
    topRatedByGuests: 'Les mieux notés par des voyageurs comme vous',
    seeAllHotels: 'Voir tous les hôtels',
    listYourHotel: 'Inscrivez votre hôtel sur Holibayt',
    reachMillions: 'Atteignez des millions de voyageurs et développez votre activité',
    startListing: 'Commencer l\'inscription',
    excellent: 'Excellent',
    fromPrice: 'À partir de',
    hotelsType: 'Hôtels',
    hotelsTypeDesc: 'Service professionnel, ménage quotidien',
    resortsType: 'Complexes',
    resortsTypeDesc: 'Expériences de luxe tout compris',
    boutiqueHotelsType: 'Hôtels Boutique',
    boutiqueHotelsDesc: 'Séjours intimes, axés sur le design',
    businessHotelsType: 'Hôtels d\'Affaires',
    businessHotelsDesc: 'Équipements et commodités d\'entreprise',
    
    // Footer
    footerTagline: 'Découvrez l\'Algérie différemment. Hôtels premium et maisons vérifiées à travers les plus belles destinations d\'Algérie.',
    discoverFooter: 'Découvrir',
  ...
  EN: {
    ...
    about: 'About',
    aboutHolibayt: 'About Holibayt',
    aboutHeroSubtitle: 'Redefining hospitality in Algeria through curated luxury experiences and authentic connections',
    ourMissionTitle: 'Our Mission',
    ourMissionText: 'Holibayt is on a mission to showcase the beauty and hospitality of Algeria to the world. We carefully curate luxury hotels and authentic short stays that represent the best of Algerian culture, architecture, and warmth. Every property on our platform is personally inspected to ensure it meets our exacting standards for quality, authenticity, and excellence.',
    ourValuesTitle: 'Our Values',
    valueTrust: 'Trust',
    valueTrustDesc: 'Every property is verified and inspected to ensure safety and quality standards',
    valueExcellence: 'Excellence',
    valueExcellenceDesc: 'We partner only with properties that demonstrate exceptional hospitality',
    valueAuthenticity: 'Authenticity',
    valueAuthenticityDesc: 'Genuine experiences that showcase the true spirit of Algerian culture',
    valueCommunity: 'Community',
    valueCommunityDesc: 'Supporting local businesses and fostering connections between hosts and guests',
    ourTeamTitle: 'Our Team',
    ourTeamSubtitle: 'A dedicated group of hospitality experts, local guides, and technology innovators',
    teamMember1Name: 'Amina Benali',
    teamMember1Role: 'CEO & Founder',
    teamMember2Name: 'Karim Mansouri',
    teamMember2Role: 'Head of Operations',
    teamMember3Name: 'Leila Cherif',
    teamMember3Role: 'Director of Hospitality',
    blog: 'Blog',
    login: 'Login',
    ...
    // Hotels Page
    findYourIdealHotel: 'Find your ideal hotel in Algeria',
    fromLuxuryResorts: 'From luxury resorts to business hotels - compare prices and book direct',
    trendingDestinations: 'Trending destinations',
    mostPopularChoices: 'Most popular choices for travelers in Algeria',
    browseByAccommodation: 'Browse by accommodation type',
    discoverStaysStyle: 'Discover stays to suit your style',
    highlyRatedHotels: 'Highly rated hotels',
    topRatedByGuests: 'Top-rated by guests like you',
    seeAllHotels: 'See all hotels',
    listYourHotel: 'List your hotel on Holibayt',
    reachMillions: 'Reach millions of travelers and grow your business',
    startListing: 'Start listing',
    excellent: 'Excellent',
    fromPrice: 'From',
    hotelsType: 'Hotels',
    hotelsTypeDesc: 'Professional service, daily housekeeping',
    resortsType: 'Resorts',
    resortsTypeDesc: 'All-inclusive luxury experiences',
    boutiqueHotelsType: 'Boutique Hotels',
    boutiqueHotelsDesc: 'Intimate, design-focused stays',
    businessHotelsType: 'Business Hotels',
    businessHotelsDesc: 'Corporate amenities and convenience',
    
    // Footer
    footerTagline: 'Discover Algeria differently. Premium hotels and verified homes across Algeria\'s most beautiful destinations.',
    discoverFooter: 'Discover',
